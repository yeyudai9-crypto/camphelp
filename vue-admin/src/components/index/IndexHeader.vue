<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block","order":"2"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"24px","color":"inherit","float":"left"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
		...
		<el-dropdown @command="handleCommand" trigger="click" :style='{"fontSize":"inherit","position":"absolute","right":"20px","color":"inherit","display":"flex"}'>
		  ...
		  <el-dropdown-menu class="top-el-dropdown-menu" slot="dropdown">
		    ...
		    <el-dropdown-item class="item2" :command="'center'">个人资料</el-dropdown-item>
