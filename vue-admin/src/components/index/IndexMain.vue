<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"boxShadow":"0 1px 6px rgba(64, 158, 255, .2)","padding":"8px 380px 8px 50px","alignItems":"center","color":"#fff","background":"url(http://codegen.caihongy.cn/20230712/4aa412b0dc964e6eacefe05d6d642149.jpg)","display":"flex","width":"100%","fontSize":"16px","position":"relative","justifyContent":"space-between","zIndex":"1"}'></index-header>
			...
			<template v-if="'vertical' == 'vertical'">
			  ...
			  <template v-if="2 == 2">
				<index-aside :is-collapse="isCollapse" @oncollapsechange="collapseChange" :style='isCollapse ? {"boxShadow":"0px 0 0px rgba(86,178,198,.3)","padding":"45px 4px 0 0","bottom":"0","transition":"width 0.3s","overflow":"hidden","top":"0","left":"0","background":"rgba(86,178,198,.5)","width":"64px","fontSize":"0px","position":"fixed","height":"100%","zIndex":"1001"} : {"boxShadow":"0px 0 0px rgba(86,178,198,.3)","padding":"45px 0 0","bottom":"0","transition":"width 0.3s","overflow":"hidden","top":"0","left":"0","background":"rgba(86,178,198,.5)","width":"210px","fontSize":"16px","position":"fixed","height":"100%","zIndex":"1001"}'></index-aside>
			  </template>
			</template>
