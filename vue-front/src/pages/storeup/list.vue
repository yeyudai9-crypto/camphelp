...
<div :style='{"width":"60%","padding":"20px","margin":"0 auto","overflow":"hidden","position":"relative","background":"#fff"}'>
    ...
    <div v-if="storeupType==1" class="section-title" :style='{"margin":"10px 0","color":"#333","textAlign":"center","background":"#fff","width":"100%","fontSize":"24px","lineHeight":"54px","fontWeight":"600","order":"0"}'>我的收藏</div>
