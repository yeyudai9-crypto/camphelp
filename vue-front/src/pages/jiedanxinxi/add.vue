...
<div :style='{"width":"60%","padding":"20px","margin":"0 auto","overflow":"hidden","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="80px"
    >
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="订单号" prop="dingdanhao">
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="配送账号" prop="peisongzhanghao">
            <el-input  v-model="ruleForm.peisongzhanghao" 
                placeholder="配送账号" clearable :disabled="true  ||ro.peisongzhanghao"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}'  label="快递状态" prop="kuaidizhuangtai">
            <el-select v-model="ruleForm.kuaidizhuangtai" placeholder="请选择快递状态" disabled >
              <el-option
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="接单时间" prop="jiedanshijian">
              <el-date-picker
          ...
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="配送人" prop="peisongren">
            <el-input  v-model="ruleForm.peisongren" 
                placeholder="配送人" clearable :disabled=" false  ||ro.peisongren"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"45%","padding":"10px","margin":"0 2% 10px","background":"#fff","display":"inline-block"}' label="路线规划" prop="luxianguihua">
            <editor 
...
<script>
  export default {
      ...
      init(type) {
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if((json.peisongren!=''&&json.peisongren) || json.peisongren==0){
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`jiedanxinxi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
			...
			this.$refs["ruleForm"].validate(valid => {
				if(valid) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('jiedanxinxi/list', {
							params: params
						}).then(res => {
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`jiedanxinxi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
