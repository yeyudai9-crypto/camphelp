...
<div>
	<div :style='{"padding":"0 20px","margin":"-60px 0 0 0","borderRadius":"0","alignItems":"center","background":"rgba(0,0,0,0.5)","display":"flex","width":"100%","justifyContent":"center","height":"60px"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'Ξ'" :style='{"alignItems":"center","background":"rgba(0,0,0,0.5)","display":"flex","width":"100%","fontSize":"14px","justifyContent":"center","zIndex":"11","height":"100%"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/daiqupingjia"><a>{{item.name}}</a></el-breadcrumb-item>
		...
		<div class="attr" :style='{"width":"60%","padding":"0px","position":"relative","background":"#fff","display":"flex","order":"1"}'>
			...
			<div class="info" :style='{"padding":"0px","margin":"0px","background":"#ffffff","flex":"1"}'>
				<div class="item" :style='{"padding":"10px","margin":"0 0 2px 0","alignItems":"center","background":"#ffffff","justifyContent":"space-between","display":"flex"}'>
                    ...
                    {{detail.peisongzhanghao}}
                    </div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>快递单号</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.kuaididanhao}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>快递名称</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.kuaidimingcheng}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>快递类型</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.kuaidileixing}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>快递备注</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.kuaidibeizhu}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>代取费用</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.daiqufeiyong}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>账号</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.zhanghao}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>手机</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.shouji}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>取货地址</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.quhuodizhi}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>目的地址</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.mudedizhi}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>配送账号</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.peisongzhanghao}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>联系电话</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.lianxidianhua}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>评价时间</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.pingjiashijian}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>评分</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.pingfen}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>评价</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.pingjia}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#E5AD12","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('daiqupingjia','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#ff721b","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('daiqupingjia','删除')" @click="delClick">删除</el-button>
					<!-- hasChat 无 -->
				</div>
			</div>
		</div>
  ...
  export default {
    ...
    methods: {
        ...
        init() {
          ...
          this.$http.get(this.tablename + '/detail/'  + this.id, {}).then(res => {
            if (res.data.code == 0) {
              ...
              this.title = this.detail.peisongzhanghao;
              this.$forceUpdate();
      ...
      nextClick(page) {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/daiqupingjiaAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		delClick(){
			this.$confirm('是否删除此代取评价？')
			  .then(_ => {
			    this.$http.post('daiqupingjia/delete', [this.detail.id]).then(res => {
			      if (res.data.code == 0) {
			        this.$message({
			          type: 'success',
			          message: '删除成功!',
