...
<div>
	<div :style='{"padding":"0 20px","margin":"-60px 0 0 0","borderRadius":"0","alignItems":"center","background":"rgba(0,0,0,0.5)","display":"flex","width":"100%","justifyContent":"center","height":"60px"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'Ξ'" :style='{"alignItems":"center","background":"rgba(0,0,0,0.5)","display":"flex","width":"100%","fontSize":"14px","justifyContent":"center","zIndex":"11","height":"100%"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/songdadingdan"><a>{{item.name}}</a></el-breadcrumb-item>
	...
	<div class="detail-preview" :style='{"margin":"20px auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"60%","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"width":"60%","padding":"0px","position":"relative","background":"#fff","display":"flex","order":"1"}'>
			...
			<div class="info" :style='{"padding":"0px","margin":"0px","background":"#ffffff","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>送达时间</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.songdashijian}}</div>
				</div>
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#ffffff","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"center","width":"auto","fontSize":"14px","lineHeight":"24px","height":"auto"}'>配送人</div>
					<div  :style='{"padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666","flex":"1","height":"auto"}'>{{detail.peisongren}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#E5AD12","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('songdadingdan','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#ff721b","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('songdadingdan','删除')" @click="delClick">删除</el-button>
					<!-- hasChat 无 -->
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#FF721B","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('songdadingdan','服务评价')" @click="onAcross('daiqupingjia','','','')" type="warning">服务评价</el-button>
				</div>
			</div>
		</div>
  ...
  export default {
    ...
    methods: {
      ...
      onAcross(acrossTable,crossOptAudit,statusColumnName,tips,statusColumnValue){
        localStorage.setItem('crossTable',`songdadingdan`);
      ...
      nextClick(page) {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/songdadingdanAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		delClick(){
			this.$confirm('是否删除此送达订单？')
			  .then(_ => {
			    this.$http.post('songdadingdan/delete', [this.detail.id]).then(res => {
			      if (res.data.code == 0) {
			        this.$message({
			          type: 'success',
			          message: '删除成功!',
